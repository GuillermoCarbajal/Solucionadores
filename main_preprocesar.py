...
from utils.CDE import conciden_fechas_nacimiento_digitadas_y_calculadas, agregar_datos_CDE_en_IAE, \
                      agregar_atributo_CAT_SUI, argegar_atributo_CAT_MCEXSUI, agregar_si_intentos_en_CDE
...
def preprocesar(args):
    ...
    df_IAE = preprocesar_CNV(df_IAE_CNV, df_IAE, dataset)
    ...
    df_IAE_RUCAF = preprocesar_RUCAF(df_IAE_RUCAF)
